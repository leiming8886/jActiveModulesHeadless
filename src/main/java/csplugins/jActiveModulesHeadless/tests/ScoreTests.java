...
public class ScoreTests  {
	...
	protected Set<Set<Node>> findSubnetworks(int size) {
		...
		System.out.println("hifindSubnetworks. Number of Subnetworks of size " + size + ": " + listOfNodes.size());
	...
	public void getSubNetworkSizesDown(int range)
	{
		...
		for(int i = (network.getNodeCount() - 1);i>=range;i--)
		{
			...
			// findSubnetworks(i);
			System.out.println("higetSubNetworkSizesDown.Number of Subnetworks of size " + i + ": " + listOfNodes.size());
		}
